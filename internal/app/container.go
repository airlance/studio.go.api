...
func NewContainer(ctx context.Context) (*Container, error) {
	...
	countryRepo := data.NewCountryRepository(db)
	...
	avatarStorage, err := storage.NewMinIOPublicStorage(ctx, cfg.Storage)
	if err != nil {
	...
	return &Container{
		...
		ManagerHandler:      handler.NewManagerHandler(managerUC, avatarStorage, cfg.Storage),
